    ...
    <header className="bg-white shadow-sm border-b border-gray-100">
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link to="/cart" className="text-gray-700 hover:text-purple-600 transition-colors font-medium">
            Cart
          </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          {!token ? (
            <>
              ...
              <Link to="/signup" className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-6 py-2.5 rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md">
                Register
              </Link>
            </>
          ) : (
            <>
              <Link to="/profile" className="flex items-center gap-3 text-gray-700 hover:text-purple-600 transition-colors font-medium">
